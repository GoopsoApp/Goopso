    ...
    return (
      <View style={{flex:1}}>
        ...
        <View style={styles.container}>
          ...
          <View style={{alignItems:'center',justifyContent:'center',marginHorizontal:(Screen.width/100)*10}}>
            <Text style={{color:'#b7b7b7',fontSize:16}}>By tapping Sign Up, you agree to the</Text><Text style={{color:'#ffffff',fontSize:16}}> Terms of Service </Text><Text style={{color:'#b7b7b7',fontSize:16}}>and</Text><Text style={{color:'#ffffff',fontSize:16}}> Privacy Policy</Text>
          </View>
